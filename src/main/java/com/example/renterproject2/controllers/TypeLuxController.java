...
public class TypeLuxController {
    ...
    @FXML
    private ListView<Cars> listViewLux;
    ...
    void onSearchButtonClicked(ActionEvent event) {
        ...
        carServices.addToRentInfoL(inn, carId, endDate);
    }

    @FXML
    void initialize() {
        ArrayList<Cars> luxCars = carServices.getAllLuxCars();
        listViewLux.setItems(FXCollections.observableList(luxCars));
    }
